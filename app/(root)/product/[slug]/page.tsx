...
export default async function ProductPage({ params }: ProductPageProps) {
  ...
  return (
    <div className="max-w-5xl mx-auto py-10 px-4 grid grid-cols-1 md:grid-cols-12 gap-8">
      {/* Product Image */}
      <div className="md:col-span-5 flex items-center justify-center bg-white rounded-lg shadow p-6">
        <Image
